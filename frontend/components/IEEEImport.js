...
export const IEEEImport = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await Promise.all([fetchIEEEAuthorDetails(), fetchIEEEAuthorPapers()]);
  };
  ...
  return (
    <div className="max-w-4xl mx-auto ">
      ...
      {!isLoadingAuthorInfo && data && <PublicationData data={data} />}
      {!isLoadingPapers && authorPapers && (
        <ImportPaperData data={authorPapers} />
      )}
    </div>
  );
};
